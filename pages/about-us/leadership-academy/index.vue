<template>
  <div>
    ...
    <HeroSection
      ...
      subtitle="Through the Leadership Academy, Tri-Lakes Board of Realtors members gain practical skills and leadership experience to thrive personally and professionally."
      variant="compact"
    ...
    <div class="container mx-auto px-6 py-12">
      ...
      <section class="mb-20">
        <div class="prose prose-lg max-w-none mb-12">
          <p class="text-lg text-gray-700 leading-relaxed mb-6">
            The Tri-Lakes Board of Realtors Leadership Academy develops future leaders through comprehensive training, networking, mentorship, and advanced professional development. Launched in 2018 and modeled after successful programs at Missouri REALTORS® and the National Association of REALTORS®, the Academy equips members with skills they can apply in both business and life while providing insight into leadership at the local, state, and national levels.
          </p>
          <p class="text-lg text-gray-700 leading-relaxed">
            Graduates gain the confidence, skills, and connections to make a meaningful impact within the real estate profession and beyond. The program offers an immersive leadership experience designed to inspire growth, foster collaboration, and develop skilled leaders who advance the Tri-Lakes Board of Realtors and the REALTOR® community.
          </p>
        </div>
      </section>
      ...
      <section class="mb-20">
        ...
        <!-- Current Class Photo -->
        <!-- Image placeholder - add photo when available -->
        <!--
...
useSeoMeta({
  ...
  description:
    "Develop leadership skills and get involved with Tri-Lakes Board of Realtors' Leadership Academy program, designed to cultivate future leaders.",
...
// Note: Image paths commented out until photos are added back
